...
#define CONFIG_APPTRACE_DEST_UART0 1
#define CONFIG_APPTRACE_UART_TX_GPIO 1
#define CONFIG_APPTRACE_UART_RX_GPIO 3
#define CONFIG_APPTRACE_UART_BAUDRATE 115200
#define CONFIG_APPTRACE_UART_RX_BUFF_SIZE 1024
